...
const PMCheckpointHistory = () => {
  ...
  const handleGenerateReport = () => {
    ...
    // Fetch report data for Preventive Maintenance Checkpoint History from the correct API endpoint
  ...
  const columns = [
    ...
    { title: 'CheckArea', dataIndex: 'CheckArea', key: 'CheckArea',ellipsis: true,width: 110 ,onHeaderCell: () => ({ style: { backgroundColor: '#f5f5f5' } })   },
    { title: 'CheckPointItems', dataIndex: 'CheckPointItems', key: 'CheckPointItems',ellipsis: true,width: 150 ,onHeaderCell: () => ({ style: { backgroundColor: '#f5f5f5' } })  },
    { title: 'CheckPointArea', dataIndex: 'CheckPointArea', key: 'CheckPointArea',ellipsis: true,width: 150 ,onHeaderCell: () => ({ style: { backgroundColor: '#f5f5f5' } })  },
    ...
    { title: 'JudgementCriteria', dataIndex: 'JudgementCriteria', key: 'JudgementCriteria',ellipsis: true,width: 160 ,onHeaderCell: () => ({ style: { backgroundColor: '#f5f5f5' } })   },
    { title: 'CheckListType', dataIndex: 'CheckListType', key: 'CheckListType',ellipsis: true,width: 150 ,onHeaderCell: () => ({ style: { backgroundColor: '#f5f5f5' } })   },
    { title: 'CheckPointType', dataIndex: 'CheckPointType', key: 'CheckPointType',ellipsis: true,width: 150 ,onHeaderCell: () => ({ style: { backgroundColor: '#f5f5f5' } })   },
    { title: 'UOM', dataIndex: 'UOM', key: 'UOM',ellipsis: true,width: 70 ,onHeaderCell: () => ({ style: { backgroundColor: '#f5f5f5' } })  },
    { title: 'UpperLimit', dataIndex: 'UpperLimit', key: 'UpperLimit' ,ellipsis: true,width: 130,onHeaderCell: () => ({ style: { backgroundColor: '#f5f5f5' } })  },
    { title: 'LowerLimit', dataIndex: 'LowerLimit', key: 'LowerLimit',ellipsis: true,width: 130 ,onHeaderCell: () => ({ style: { backgroundColor: '#f5f5f5' } })   },
    { title: 'Standard', dataIndex: 'Standard', key: 'Standard',ellipsis: true,width: 140,onHeaderCell: () => ({ style: { backgroundColor: '#f5f5f5' } })   },
    { title: 'CheckPointValue', dataIndex: 'CheckPointValue', key: 'CheckPointValue' ,ellipsis: true,width: 160 ,onHeaderCell: () => ({ style: { backgroundColor: '#f5f5f5' } })  },
  ...
  return (
    <div style={{ padding: '24px', backgroundColor: '#e0e2e5', minHeight: '84vh' ,maxWidth:'34%' }}>
